...
if "Joe" in phonebook:
    ...
    print("Joe is not in the phonebook")
...
for k in phonebook:
    #print(k) will give you the keys, or the names. Below will give values of keys
    print(phonebook[k])
...
for pair in phonebook.items():
    print(pair)
    # can also say "for k,v" and print(k,v) istead of "for pair" and print(pair)
    # outcome is a tuple when they are paired together (immutable)
    print(type(pair))
